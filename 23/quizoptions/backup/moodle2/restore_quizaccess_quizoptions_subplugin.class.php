...
/**
 * Provides the information to restore the quizoptions quiz access plugin.
 *
 ...
 */
class restore_quizaccess_quizoptions_subplugin extends restore_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/quizaccess_quizoptions');
    ...
    /**
     * Processes the quizaccess_quizoptions element, if it is in the file.
     * @param array $data the data read from the XML file.
     */
    public function process_quizaccess_quizoptions($data) {
        global $DB;

        $data = (object)$data;
        $data->quizid = $this->get_new_parentid('quiz');
        $DB->insert_record('quizaccess_quizoptions', $data);
    }
}
